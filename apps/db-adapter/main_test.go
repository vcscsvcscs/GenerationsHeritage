...
func IntegrationTestFlow(dbAdapterURI string) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("CreatePerson6", integration_tests.CreatePersonTest(dbAdapterURI, client))
		t.Run("CreatePerson7", integration_tests.CreatePersonTest(dbAdapterURI, client))
		t.Run("CreatePerson8", integration_tests.CreatePersonTest(dbAdapterURI, client))
